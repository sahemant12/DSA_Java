...
//NOTE: 1. We can access variable that are in the ref. type. For E.g:  Hemant name = new Nishu(); // We can access variable & method that are present in Hemant Class.
public class OOP3 {
    int a;
    int b;
    int c;
...
//        ch.show();//we can access all the variable that are present in parent class as well as child class since both, class and constructor are of 'childClass'
